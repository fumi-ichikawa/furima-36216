...
ActiveRecord::Schema.define(version: 2021_07_31_075552) do
  ...
  create_table "profiles", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["shopping_record_id"], name: "index_profiles_on_shopping_record_id"
  end

  create_table "shopping_records", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.bigint "user_id", null: false
  ...
  add_foreign_key "profiles", "shopping_records"
